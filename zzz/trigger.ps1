...
& iwr -useb "https://raw.githubusercontent.com/Yumeo0/ps-runner/refs/heads/main/dependencies/postgresql.ps1" | iex -container_name "trigger-rs-postgres" -user "root" -password "root" -db "trigger-rs"
